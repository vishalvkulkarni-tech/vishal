###########################################################################
## Makefile generated for component 'addition_model'. 
## 
## Makefile     : addition_model.mk
## Generated on : Thu Feb 05 17:23:26 2026
## Final product: ./addition_model.exe
...
PRODUCT_NAME              = addition_model
MAKEFILE                  = addition_model.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2024b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2024b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/z004f2se/ONEDRI~1/Vishal/Personal/vishal/MATLAB/simulink/model4
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = addition_model_comp.rsp
CMD_FILE                  = addition_model.rsp
...
DEFINES_OPTS = -DTGTCONN -DIS_SIM_TARGET -DNRT -DRSIM_PARAMETER_LOADING -DRSIM_WITH_SL_SOLVER -DUSE_LOCALHOST -DENABLE_SLEXEC_SSBRIDGE=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=0
DEFINES_STANDARD = -DMODEL=addition_model -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/raccel/addition_model/addition_model.c $(START_DIR)/slprj/raccel/addition_model/addition_model_capi.c $(START_DIR)/slprj/raccel/addition_model/addition_model_data.c $(START_DIR)/slprj/raccel/addition_model/addition_model_tgtconn.c $(START_DIR)/slprj/raccel/addition_model/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
...
OBJS = addition_model.obj addition_model_capi.obj addition_model_data.obj addition_model_tgtconn.obj rt_nonfinite.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
%.obj : $(START_DIR)/slprj/raccel/addition_model/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/addition_model/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/addition_model/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/addition_model/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/addition_model/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
addition_model.obj : $(START_DIR)/slprj/raccel/addition_model/addition_model.c
	$(CC) $(CFLAGS) -o "$@" "$<"


addition_model_capi.obj : $(START_DIR)/slprj/raccel/addition_model/addition_model_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


addition_model_data.obj : $(START_DIR)/slprj/raccel/addition_model/addition_model_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


addition_model_tgtconn.obj : $(START_DIR)/slprj/raccel/addition_model/addition_model_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/addition_model/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
