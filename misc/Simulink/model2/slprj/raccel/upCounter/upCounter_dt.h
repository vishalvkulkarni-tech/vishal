...
rtBTransitions [ ] = { { ( char_T * ) ( & rtB . gadqaf0p0q ) , 0 , 0 , 1 } ,
{ ( char_T * ) ( & rtDW . ixowekr02h ) , 0 , 0 , 1 } , { ( char_T * ) ( &
rtDW . mrbztfizgc . LoggedData ) , 11 , 0 , 2 } } ; static
DataTypeTransitionTable rtBTransTable = { 3U , rtBTransitions } ; static
DataTypeTransition rtPTransitions [ ] = { { ( char_T * ) ( & rtP . maxCnt ) ,
0 , 0 , 4 } } ; static DataTypeTransitionTable rtPTransTable = { 1U ,
rtPTransitions } ;
