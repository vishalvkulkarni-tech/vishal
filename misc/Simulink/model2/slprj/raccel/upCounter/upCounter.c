...
#include "upCounter_capi.h"
#include "upCounter_dt.h"
...
model_S ; void MdlInitialize ( void ) { rtDW . ixowekr02h = rtP .
...
srcInfo ; sdiLabelU loggedName = sdiGetLabelFromChars ( "counterOutput" ) ;
sdiLabelU origSigName = sdiGetLabelFromChars ( "counterOutput" ) ; sdiLabelU
propName = sdiGetLabelFromChars ( "" ) ; sdiLabelU blockPath =
sdiGetLabelFromChars ( "upCounter/Switch" ) ; sdiLabelU blockSID =
sdiGetLabelFromChars ( "" ) ; sdiLabelU subPath = sdiGetLabelFromChars ( "" )
; sdiDims sigDims ; sdiLabelU sigName = sdiGetLabelFromChars (
"counterOutput" ) ; sdiAsyncRepoDataTypeHandle hDT =
...
. jtb1hitivp . AQHandles = sdiStartAsyncioQueueCreation ( hDT , & srcInfo ,
rt_dataMapInfo . mmi . InstanceMap . fullPath ,
"cb938c53-cdda-4f6b-884c-a696160f168e" , sigComplexity , & sigDims ,
DIMENSIONS_MODE_FIXED , stCont , "" ) ; sdiCompleteAsyncioQueueCreation (
rtDW . jtb1hitivp . AQHandles , hDT , & srcInfo ) ; if ( rtDW . jtb1hitivp .
AQHandles ) { sdiSetSignalSampleTimeString ( rtDW . jtb1hitivp . AQHandles ,
"0.2" , 0.2 , ssGetTFinal ( rtS ) ) ; sdiSetSignalRefRate ( rtDW . jtb1hitivp
. AQHandles , 0.0 ) ; sdiSetRunStartTime ( rtDW . jtb1hitivp . AQHandles ,
ssGetTaskTime ( rtS , 0 ) ) ; sdiAsyncRepoSetSignalExportSettings ( rtDW .
jtb1hitivp . AQHandles , 1 , 0 ) ; sdiAsyncRepoSetSignalExportName ( rtDW .
jtb1hitivp . AQHandles , loggedName , origSigName , propName ) ; }
sdiFreeLabel ( sigName ) ; sdiFreeLabel ( loggedName ) ; sdiFreeLabel (
origSigName ) ; sdiFreeLabel ( propName ) ; sdiFreeLabel ( blockPath ) ;
sdiFreeLabel ( blockSID ) ; sdiFreeLabel ( subPath ) ; } } if ( !
isStreamoutAlreadyRegistered ) { } } } } MdlInitialize ( ) ; } void
MdlOutputs ( int_T tid ) { real_T bgmzkstxnv ; bgmzkstxnv = rtDW . ixowekr02h
+ rtP . AddConstant_Bias ; if ( bgmzkstxnv > rtP . maxCnt ) { rtB .
gadqaf0p0q = rtP . Constant_Value ; } else { rtB . gadqaf0p0q = bgmzkstxnv ;
} { if ( rtDW . jtb1hitivp . AQHandles && ssGetLogOutput ( rtS ) ) {
sdiWriteSignal ( rtDW . jtb1hitivp . AQHandles , ssGetTaskTime ( rtS , 0 ) ,
( char * ) & rtB . gadqaf0p0q + 0 ) ; } } UNUSED_PARAMETER ( tid ) ; } void
MdlOutputsTID1 ( int_T tid ) { UNUSED_PARAMETER ( tid ) ; } void MdlUpdate (
int_T tid ) { rtDW . ixowekr02h = rtB . gadqaf0p0q ; UNUSED_PARAMETER ( tid )
; } void MdlUpdateTID1 ( int_T tid ) { UNUSED_PARAMETER ( tid ) ; } void
MdlTerminate ( void ) { { if ( rtDW . jtb1hitivp . AQHandles ) {
sdiTerminateStreaming ( & rtDW . jtb1hitivp . AQHandles ) ; } } } static void
mr_upCounter_cacheDataAsMxArray ( mxArray * destArray , mwIndex i , int j ,
...
; } static void mr_upCounter_restoreDataFromMxArray ( void * destData , const
mxArray * srcArray , mwIndex i , int j , size_t numBytes ) ; static void
mr_upCounter_restoreDataFromMxArray ( void * destData , const mxArray *
srcArray , mwIndex i , int j , size_t numBytes ) { memcpy ( ( uint8_T * )
destData , ( const uint8_T * ) mxGetData ( mxGetFieldByNumber ( srcArray , i
, j ) ) , numBytes ) ; } static void mr_upCounter_cacheBitFieldToMxArray (
mxArray * destArray , mwIndex i , int j , uint_T bitVal ) ; static void
mr_upCounter_cacheBitFieldToMxArray ( mxArray * destArray , mwIndex i , int j
, uint_T bitVal ) { mxSetFieldByNumber ( destArray , i , j ,
mxCreateDoubleScalar ( ( real_T ) bitVal ) ) ; } static uint_T
mr_upCounter_extractBitFieldFromMxArray ( const mxArray * srcArray , mwIndex
i , int j , uint_T numBits ) ; static uint_T
mr_upCounter_extractBitFieldFromMxArray ( const mxArray * srcArray , mwIndex
i , int j , uint_T numBits ) { const uint_T varVal = ( uint_T ) mxGetScalar (
mxGetFieldByNumber ( srcArray , i , j ) ) ; return varVal & ( ( 1u << numBits
) - 1u ) ; } static void mr_upCounter_cacheDataToMxArrayWithOffset ( mxArray
* destArray , mwIndex i , int j , mwIndex offset , const void * srcData ,
size_t numBytes ) ; static void mr_upCounter_cacheDataToMxArrayWithOffset (
mxArray * destArray , mwIndex i , int j , mwIndex offset , const void *
srcData , size_t numBytes ) { uint8_T * varData = ( uint8_T * ) mxGetData (
mxGetFieldByNumber ( destArray , i , j ) ) ; memcpy ( ( uint8_T * ) & varData
[ offset * numBytes ] , ( const uint8_T * ) srcData , numBytes ) ; } static
void mr_upCounter_restoreDataFromMxArrayWithOffset ( void * destData , const
mxArray * srcArray , mwIndex i , int j , mwIndex offset , size_t numBytes ) ;
static void mr_upCounter_restoreDataFromMxArrayWithOffset ( void * destData ,
const mxArray * srcArray , mwIndex i , int j , mwIndex offset , size_t
numBytes ) { const uint8_T * varData = ( const uint8_T * ) mxGetData (
mxGetFieldByNumber ( srcArray , i , j ) ) ; memcpy ( ( uint8_T * ) destData ,
( const uint8_T * ) & varData [ offset * numBytes ] , numBytes ) ; } static
void mr_upCounter_cacheBitFieldToCellArrayWithOffset ( mxArray * destArray ,
mwIndex i , int j , mwIndex offset , uint_T fieldVal ) ; static void
mr_upCounter_cacheBitFieldToCellArrayWithOffset ( mxArray * destArray ,
mwIndex i , int j , mwIndex offset , uint_T fieldVal ) { mxSetCell (
mxGetFieldByNumber ( destArray , i , j ) , offset , mxCreateDoubleScalar ( (
real_T ) fieldVal ) ) ; } static uint_T
mr_upCounter_extractBitFieldFromCellArrayWithOffset ( const mxArray *
srcArray , mwIndex i , int j , mwIndex offset , uint_T numBits ) ; static
uint_T mr_upCounter_extractBitFieldFromCellArrayWithOffset ( const mxArray *
srcArray , mwIndex i , int j , mwIndex offset , uint_T numBits ) { const
uint_T fieldVal = ( uint_T ) mxGetScalar ( mxGetCell ( mxGetFieldByNumber (
srcArray , i , j ) , offset ) ) ; return fieldVal & ( ( 1u << numBits ) - 1u
) ; } mxArray * mr_upCounter_GetDWork ( ) { static const char_T *
ssDWFieldNames [ 3 ] = { "rtB" , "rtDW" , "NULL_PrevZCX" , } ; mxArray * ssDW
= mxCreateStructMatrix ( 1 , 1 , 3 , ssDWFieldNames ) ;
mr_upCounter_cacheDataAsMxArray ( ssDW , 0 , 0 , ( const void * ) & ( rtB ) ,
sizeof ( rtB ) ) ; { static const char_T * rtdwDataFieldNames [ 1 ] = {
"rtDW.ixowekr02h" , } ; mxArray * rtdwData = mxCreateStructMatrix ( 1 , 1 , 1
, rtdwDataFieldNames ) ; mr_upCounter_cacheDataAsMxArray ( rtdwData , 0 , 0 ,
( const void * ) & ( rtDW . ixowekr02h ) , sizeof ( rtDW . ixowekr02h ) ) ;
mxSetFieldByNumber ( ssDW , 0 , 1 , rtdwData ) ; } return ssDW ; } void
mr_upCounter_SetDWork ( const mxArray * ssDW ) { ( void ) ssDW ;
mr_upCounter_restoreDataFromMxArray ( ( void * ) & ( rtB ) , ssDW , 0 , 0 ,
sizeof ( rtB ) ) ; { const mxArray * rtdwData = mxGetFieldByNumber ( ssDW , 0
, 1 ) ; mr_upCounter_restoreDataFromMxArray ( ( void * ) & ( rtDW .
ixowekr02h ) , rtdwData , 0 , 0 , sizeof ( rtDW . ixowekr02h ) ) ; } }
mxArray * mr_upCounter_GetSimStateDisallowedBlocks ( ) { mxArray * data =
mxCreateCellMatrix ( 1 , 3 ) ; mwIndex subs [ 2 ] , offset ; { static const
char_T * blockType [ 1 ] = { "Scope" , } ; static const char_T * blockPath [
1 ] = { "upCounter/Scope" , } ; static const int reason [ 1 ] = { 0 , } ; for
...
( rtS , 0 ) ; ssSetNumSampleTimes ( rtS , 1 ) ; ssSetNumBlocks ( rtS , 6 ) ;
ssSetNumBlockIO ( rtS , 1 ) ; ssSetNumBlockParams ( rtS , 4 ) ; } void
MdlInitializeSampleTimes ( void ) { ssSetSampleTime ( rtS , 0 , 0.2 ) ;
ssSetOffsetTime ( rtS , 0 , 0.0 ) ; } void raccel_set_checksum ( ) {
ssSetChecksumVal ( rtS , 0 , 2629790157U ) ; ssSetChecksumVal ( rtS , 1 ,
2963404611U ) ; ssSetChecksumVal ( rtS , 2 , 177670560U ) ; ssSetChecksumVal
( rtS , 3 , 2010211719U ) ; }
#if defined(_MSC_VER)
#pragma optimize( "", off )
#endif
...
dataTypeInfoTable = rtDataTypeInfoTable ; } upCounter_InitializeDataMapInfo (
) ; ssSetIsRapidAcceleratorActive ( rtS , true ) ; ssSetRootSS ( rtS , rtS )
; ssSetVersion ( rtS , SIMSTRUCT_VERSION_LEVEL2 ) ; ssSetModelName ( rtS ,
"upCounter" ) ; ssSetPath ( rtS , "upCounter" ) ; ssSetTStart ( rtS , 0.0 ) ;
ssSetTFinal ( rtS , rtInf ) ; ssSetStepSize ( rtS , 0.2 ) ;
ssSetFixedStepSize ( rtS , 0.2 ) ; { static RTWLogInfo rt_DataLoggingInfo ;
...
rt_LoggedStateBlockNames [ ] = { "upCounter/Unit Delay" } ; static const
...
) ; rt_LoggedStateSignalPtrs [ 0 ] = ( void * ) & rtDW . ixowekr02h ; }
...
2629790157U ) ; ssSetChecksumVal ( rtS , 1 , 2963404611U ) ; ssSetChecksumVal
( rtS , 2 , 177670560U ) ; ssSetChecksumVal ( rtS , 3 , 2010211719U ) ; {
...
mr_upCounter_GetSimStateDisallowedBlocks ) ; slsaGetWorkFcnForSimTargetOP (
rtS , mr_upCounter_GetDWork ) ; slsaSetWorkFcnForSimTargetOP ( rtS ,
mr_upCounter_SetDWork ) ; rt_RapidReadMatFileAndUpdateParams ( rtS ) ; if (
