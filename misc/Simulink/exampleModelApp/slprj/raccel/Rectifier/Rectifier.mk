###########################################################################
## Makefile generated for component 'Rectifier'. 
## 
## Makefile     : Rectifier.mk
## Generated on : Thu Jan 18 16:57:52 2024
## Final product: ./Rectifier.exe
...
COMPILER_COMMAND_FILE     = Rectifier_comp.rsp
CMD_FILE                  = Rectifier.rsp
...
DEFINES_STANDARD = -DMODEL=Rectifier -DNUMST=2 -DNCSTATES=7 -DHAVESTDIO
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_matrx.c $(MATLAB_ROOT)/rtw/c/src/rt_printf.c $(START_DIR)/slprj/raccel/Rectifier/Rectifier.c $(START_DIR)/slprj/raccel/Rectifier/Rectifier_capi.c $(START_DIR)/slprj/raccel/Rectifier/Rectifier_data.c $(START_DIR)/slprj/raccel/Rectifier/Rectifier_tgtconn.c $(START_DIR)/slprj/raccel/Rectifier/rtGetInf.c $(START_DIR)/slprj/raccel/Rectifier/rtGetNaN.c $(START_DIR)/slprj/raccel/Rectifier/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c $(MATLAB_ROOT)/toolbox/physmod/powersys/powersys/sfun_spid_contc.c
...
OBJS = rt_matrx.obj rt_printf.obj Rectifier.obj Rectifier_capi.obj Rectifier_data.obj Rectifier_tgtconn.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj sfun_spid_contc.obj
...
%.obj : $(MATLAB_ROOT)/toolbox/physmod/powersys/powersys/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(MATLAB_ROOT)/toolbox/physmod/powersys/powersys/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(MATLAB_ROOT)/toolbox/physmod/powersys/powersys/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.obj : $(START_DIR)/slprj/raccel/Rectifier/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/Rectifier/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/Rectifier/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/Rectifier/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/Rectifier/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Rectifier.obj : $(START_DIR)/slprj/raccel/Rectifier/Rectifier.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Rectifier_capi.obj : $(START_DIR)/slprj/raccel/Rectifier/Rectifier_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Rectifier_data.obj : $(START_DIR)/slprj/raccel/Rectifier/Rectifier_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Rectifier_tgtconn.obj : $(START_DIR)/slprj/raccel/Rectifier/Rectifier_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/slprj/raccel/Rectifier/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.obj : $(START_DIR)/slprj/raccel/Rectifier/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/Rectifier/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
