...
rtBTransitions [ ] = { { ( char_T * ) ( & rtB . cnnmnegtoe ) , 0 , 0 , 21 } ,
{ ( char_T * ) ( & rtDW . awq4jr4str [ 0 ] ) , 0 , 0 , 2 } , { ( char_T * ) (
& rtDW . hmqbqk2szw [ 0 ] ) , 11 , 0 , 33 } , { ( char_T * ) ( & rtDW .
elswe02dqw [ 0 ] ) , 10 , 0 , 27 } } ; static DataTypeTransitionTable
rtBTransTable = { 4U , rtBTransitions } ; static DataTypeTransition
rtPTransitions [ ] = { { ( char_T * ) ( & rtP . frequency_voltage1 ) , 0 , 0
, 1156 } } ; static DataTypeTransitionTable rtPTransTable = { 1U ,
rtPTransitions } ;
