...
int32_T IGBTThermal_399ad5b0_1_ds_lock_i ( const NeDynamicSystem * LC , const
...
t2 -> mLOCK_I ; if ( ( ( CI_idx_7 == 0 ) && ( U_idx_0 < 6.0 ) && ( ( size_t )
...
out . mX [ 1 ] = indicator1 ; out . mX [ 2 ] = ( Q_idx_2 != 0 ) ; ( void ) LC
; ( void ) t2 ; return 0 ; }
