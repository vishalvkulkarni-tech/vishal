###########################################################################
## Makefile generated for component 'upCounter'. 
## 
## Makefile     : upCounter.mk
## Generated on : Tue Jan 09 12:05:07 2024
## Final product: ./upCounter.exe
...
COMPILER_COMMAND_FILE     = upCounter_comp.rsp
CMD_FILE                  = upCounter.rsp
...
DEFINES_STANDARD = -DMODEL=upCounter -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/raccel/upCounter/rtGetInf.c $(START_DIR)/slprj/raccel/upCounter/rtGetNaN.c $(START_DIR)/slprj/raccel/upCounter/rt_nonfinite.c $(START_DIR)/slprj/raccel/upCounter/upCounter.c $(START_DIR)/slprj/raccel/upCounter/upCounter_capi.c $(START_DIR)/slprj/raccel/upCounter/upCounter_data.c $(START_DIR)/slprj/raccel/upCounter/upCounter_tgtconn.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
...
OBJS = rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj upCounter.obj upCounter_capi.obj upCounter_data.obj upCounter_tgtconn.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
%.obj : $(START_DIR)/slprj/raccel/upCounter/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/upCounter/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/upCounter/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/upCounter/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/upCounter/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
rtGetInf.obj : $(START_DIR)/slprj/raccel/upCounter/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.obj : $(START_DIR)/slprj/raccel/upCounter/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/upCounter/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"


upCounter.obj : $(START_DIR)/slprj/raccel/upCounter/upCounter.c
	$(CC) $(CFLAGS) -o "$@" "$<"


upCounter_capi.obj : $(START_DIR)/slprj/raccel/upCounter/upCounter_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


upCounter_data.obj : $(START_DIR)/slprj/raccel/upCounter/upCounter_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


upCounter_tgtconn.obj : $(START_DIR)/slprj/raccel/upCounter/upCounter_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"
