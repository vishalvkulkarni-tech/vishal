...
DataMapInfo ; struct P_ { real_T UnitDelay_InitialCondition ; real_T
AddConstant_Bias ; real_T Switch_Threshold ; real_T Constant_Value ; } ;
extern const char_T * RT_MEMORY_ALLOCATION_ERROR ; extern B rtB ; extern DW
rtDW ; extern P rtP ; extern mxArray * mr_upCounter_GetDWork ( ) ; extern
void mr_upCounter_SetDWork ( const mxArray * ssDW ) ; extern mxArray *
